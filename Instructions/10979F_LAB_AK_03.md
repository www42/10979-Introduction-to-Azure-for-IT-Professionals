...
1. On the **10979F0301-vm** blade, click **Activity log**. This will display the blade allowing you to search for activities affecting the VM that you or other admins carried out.
    ...
    > **Note**: The list of events should include a single entry corresponding to the creation of the virtual machine. Activities represent changes to the state of the VM that you or other admins carried out, such as restarting it. If the VM creation event does not appear, try clicking **Refresh** until the event displays.
...
1. In the **NAME** column, click the drop-down arrow and then, click **Create disk**. 
